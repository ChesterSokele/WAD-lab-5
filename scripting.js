...
function toggleTheme() {
  ...
  if (body.classList.contains('dark-theme')) {
    themeToggle.innerHTML = '<i class="material-icons">light_mode</i> Light Mode';
    localStorage.setItem('theme', 'dark');
  } else {
    themeToggle.innerHTML = '<i class="material-icons">dark_mode</i> Dark Mode';
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Add theme toggle button to HTML if not present
  if (!document.querySelector('.theme-toggle')) {
    const themeButton = document.createElement('button');
    themeButton.className = 'theme-toggle';
    themeButton.innerHTML = '<i class="material-icons">dark_mode</i> Dark Mode';
